...
This theme uses the Midnight Discord theme as a foundation and applies the Palenight color scheme with additional customizations including rounded corners and custom icons.
